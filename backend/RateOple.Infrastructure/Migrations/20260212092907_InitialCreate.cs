        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Rating_Value_Range", "\"Value\" >= 1 AND \"Value\" <= 10");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TvSeries", x => x.MediaId);
                    table.ForeignKey(
                        name: "FK_TvSeries_Media_MediaId",
                        column: x => x.MediaId,
                        principalTable: "Media",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupMediaLinks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GroupMediaLinks_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupMediaLinks_Media_MediaId",
                        column: x => x.MediaId,
                        principalTable: "Media",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TvSeriesId = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GroupPostId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CollectionItems_CollectionId_MediaId",
            ...
            migrationBuilder.CreateIndex(
                ...
                columns: new[] { "GroupId", "MediaId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_GroupMediaLinks_MediaId",
                table: "GroupMediaLinks",
                column: "MediaId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Seasons_TvSeriesId_SeasonNumber",
                table: "Seasons",
