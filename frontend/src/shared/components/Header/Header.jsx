...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-[var(--header-border)] bg-[var(--bg-secondary)] md:bg-[var(--header-bg)] shadow-md backdrop-blur-lg ring-1 ring-[var(--header-border)]">
